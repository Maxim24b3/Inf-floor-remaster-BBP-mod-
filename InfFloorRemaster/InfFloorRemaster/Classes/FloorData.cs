...
namespace InfFloorRemaster.Classes
{
    public class FloorData
    {
        ...
        public int CapIncrease
        {
            get
            {
                return Mathf.FloorToInt(FloorID / 10) * 5;
            }
        }
        ...
        public int mapPrice
        {
            get
            {
                return FloorID * 25 * Mathf.CeilToInt(FloorID / 8f);
            }
        }
        ...
        public int minSpecialBuilders
        {
            get
            {
                return (int)(minSize * scaleVar * 0.5f);
            }
        }

        public int maxSpecialBuilders
        {
            get
            {
                return (int)(maxSize * scaleVar * 0.5f);
            }
        }
        ...
        public float timeLimit
        {
            get
            {
                return classRoomCount * scaleVar * 0.5f;
            }
        }
    }
}
